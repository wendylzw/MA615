...
- `hurr_track` and `rain` are from `hurricaneexposuredata` package.  
...
- `geom_sf()`  for rain mapping  
- `geom_path()` function for hurr_track mapping.
...
- `tm_shape()` and `tm_polygons()` for rain mapping  
- `tm_lines()`  for hurr_track mapping
